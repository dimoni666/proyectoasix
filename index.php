...
<body>
  ...
  <ul class="navigation">
    ...
    <li data-slide="3" style="box-shadow: 0 0 0 3px #1a1a1a;background-color: #1a1a1a;"></li>
    <li data-slide="4" style="box-shadow: 0 0 0 3px #ffee00;background-color: #ffee00;"></li>
  </ul>
  ...
  <div class="slide" id="slide3" data-slide="3" data-stellar-background-ratio="0">
    <span>...hasta el data center</span>
  </div>
  ...
  <form action="formulario.php" method="post">
    ...
    <label for="consulta">Motivo: </label>
    		  <textarea name="motivo" rows="10" cols="40" maxlength="1000"></textarea><BR>
